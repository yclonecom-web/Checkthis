...
export default function Profile() {
  ...
  // Re-sync form every time the modal opens, so Settings changes are reflected
  const openEditing = () => {
    setForm({ name: currentUser.name, bio: currentUser.bio || '' });
    setEditing(true);
  };
      ...
      <header className="profile-head">
        ...
        <div className="profile-info">
          ...
          <div className="profile-actions">
            {isMe ? (
              <button type="button" className="btn btn-primary" onClick={openEditing}>
                Edit profile
              </button>
            ) : (
              <button
