...
function CarouselSlide({ url, active, title }) {
  ...
  if (type === 'video' && youtubeId) {
    // Only mount the iframe when this slide is visible — prevents background audio bleed
    if (!active) return <div className="carousel-slide-fallback" aria-hidden="true" />;
    return (
      <iframe
